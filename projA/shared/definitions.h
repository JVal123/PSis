...
//#define MAX_ALIENS (GRID_SIZE * GRID_SIZE / 3) // Maximum number of aliens allowed in the game
#define MAX_ALIENS 4
...
typedef struct {
    ...
    int active;           // Whether the astronaut is active or not (1 = active, 0 = inactive)
